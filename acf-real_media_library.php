<?php
/**
Plugin Name: Advanced Custom Fields: Real Media Library Folder Field
Plugin URI: https://devowl.io/
Description: Media library folder field for Advanced Custom Fields (ACF). Folder created by Real Media Library.
